...
// ShowSampleNotFound runs the method Show of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowSampleNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.SampleController, bottleID int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
	...
	u := &url.URL{
		Path: fmt.Sprintf("/sample/%v", bottleID),
	}
	...
	showCtx, _err := app.NewShowSampleContext(goaCtx, req, service)
	if _err != nil {
...
// ShowSampleOK runs the method Show of the given controller with the given parameters.
