...
func NewSampleAPI(spec *loads.Document) *SampleAPI {
	return &SampleAPI{
		...
		ItemsListItemsHandler: items.ListItemsHandlerFunc(func(params items.ListItemsParams) middleware.Responder {
			return middleware.NotImplemented("operation ItemsListItems has not yet been implemented")
		}),
	}
}
...
type SampleAPI struct {
	...
	// ItemsListItemsHandler sets the operation handler for the list items operation
	ItemsListItemsHandler items.ListItemsHandler
...
func (o *SampleAPI) Validate() error {
	...
	if o.ItemsListItemsHandler == nil {
		unregistered = append(unregistered, "items.ListItemsHandler")
	}
...
func (o *SampleAPI) initHandlerCache() {
	...
	o.handlers["GET"][""] = items.NewListItems(o.context, o.ItemsListItemsHandler)
