...
func (o *ListItemsOK) WithPayload(payload []*models.Item) *ListItemsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list items o k response
func (o *ListItemsOK) SetPayload(payload []*models.Item) {
	o.Payload = payload
}
...
/*ListItemsDefault generic error response
...
func (o *ListItemsDefault) WithPayload(payload *models.Error) *ListItemsDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list items default response
func (o *ListItemsDefault) SetPayload(payload *models.Error) {
	o.Payload = payload
}
